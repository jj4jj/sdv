...
class ChartAgent:
    ...
    def draw_line(self, title, name, dataset):
        self._draw(chart_id, [title], [name], ['line'], [dataset])
    ...
    def draw_ohlc(self, title, name, dataset):
        ...
        :return:
        """
        self._draw(chart_id, [title], [name], ['k'], [dataset])

    def draw_bar(self,title, name, dataset):
        self._draw(chart_id, [title], [name], ['bar'], [dataset])

    def draw_scatter_point(self, title, name, dataset):
        self._draw(chart_id, [title], [name], ['scatter'], [dataset])
